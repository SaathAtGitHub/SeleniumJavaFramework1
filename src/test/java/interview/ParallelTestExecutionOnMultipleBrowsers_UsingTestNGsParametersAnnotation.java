/* Run "testng_ParallelTestExecutionOnMultipleBrowsers.xml" (located at this project's root) by right-clicking that XML file > Run As > TestNG Test, in order to run this test (If browser
 ...
 * 
 * TEST RESULT: It's a PASS. (Run "testng_ParallelTestExecutionOnMultipleBrowsers.xml" in order to run this test, as noted above.)
 * WHAT THIS TEST DO:
...
public class ParallelTestExecutionOnMultipleBrowsers_UsingTestNGsParametersAnnotation {
