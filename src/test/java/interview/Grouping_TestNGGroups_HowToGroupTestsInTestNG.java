...
public class Grouping_TestNGGroups_HowToGroupTestsInTestNG {

	@Test(groups = { "sanity" })
	public void test1(){		System.out.println("This is test1 from 'interview.Grouping_TestNGGroups_HowToGroupTestsInTestNG.java'..");	}
	...
	public void test2(){		System.out.println("This is test2 from 'interview.Grouping_TestNGGroups_HowToGroupTestsInTestNG.java'..");	}
	
	@Test(groups = { "linux.regression" })  // "linux.regression" meaning this test is part of regression but will run on Linux systems only.
	public void test3(){		System.out.println("This is test3 from 'interview.Grouping_TestNGGroups_HowToGroupTestsInTestNG.java'..");	}
	
	@Test
	public void test4(){		System.out.println("This is test4 from 'interview.Grouping_TestNGGroups_HowToGroupTestsInTestNG.java'..");	}
}
